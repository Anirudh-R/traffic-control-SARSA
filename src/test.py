...
# Queue Length plots
plt.figure()
plt.title("Queue Length", fontsize=18)
# Static signalling
...
plt.ylabel("Percentage Queue occupancy (%)", fontsize=15)
...
# Waiting Time plots
plt.figure()
plt.title("Waiting Time", fontsize=18)
# Static signalling
...
t = [16*x/60.0 for x in range(len(avg))]
plt.plot(t, avg, label='SARSA')
plt.ylabel("Waiting Time (fraction of journey time)", fontsize=15)
plt.xlabel("time (minutes)",fontsize=15)
plt.legend()
...
# Time Loss plots
plt.figure()
plt.title("Time Loss", fontsize=18)
# Static signalling
...
t = [16*x/60.0 for x in range(len(avg))]
plt.plot(t, avg, label='SARSA')
plt.ylabel("Time Loss (fraction of journey time)", fontsize=15)
plt.xlabel("time (minutes)", fontsize=15)
plt.legend()
...
# Run length plots
plt.figure()
plt.title("Time to disperse traffic", fontsize=18)
# Static signalling
...
plt.ylabel("Dispersion time (minutes)", fontsize=15)
